        ...
        <div className='mb-20'>
            ...
            <div className='grid grid-cols-4 gap-5'>
                <div className='bg-gradient-to-r from-blue-900 to-blue-500 text-white rounded-xl p-10 flex flex-col gap-5'>
                    <div>
                        <img src="/public/assets/success-doctor.png" alt="" />
                    </div>
                ...
                <div className='bg-gradient-to-r from-blue-900 to-blue-500 text-white rounded-xl p-10 flex flex-col gap-5'>
                    <div>
                        <img src="/public/assets/success-review.png" alt="" />
                    </div>
                    <h3 className='text-6xl font-bold'>
                    <CountUp
                            start={0}
                ...
                <div className='bg-gradient-to-r from-blue-900 to-blue-500 text-white rounded-xl p-10 flex flex-col gap-5'>
                    <div>
                        <img src="/public/assets/success-patients.png" alt="" />
                    </div>
                    <h3 className='text-6xl font-bold'>
                    <CountUp
                            start={0}
                ...
                <div className='bg-gradient-to-r from-blue-900 to-blue-500 text-white rounded-xl p-10 flex flex-col gap-5'>
                    <div>
                        <img src="/public/assets/success-staffs.png" alt="" />
                    </div>
                    <h3 className='text-6xl font-bold'>
                    <CountUp
                            start={0}
